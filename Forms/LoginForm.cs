...
namespace GestiuneCarti
{
    public partial class LoginForm : Form
    {
        ...
        private async void connect_Click(object sender, EventArgs e)
        {
            ...
            //string connectionString = $"User Id={username};Password={password};Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=FREEPDB1)));Connection Timeout=30;";
