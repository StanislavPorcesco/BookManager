namespace GestiuneCarti
{
    partial class AddForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            autor_txt = new TextBox();
            loc_pub_txt = new TextBox();
            an_pub_txt = new TextBox();
            id_czu_txt = new TextBox();
            pret_txt = new TextBox();
            nr_exemp_txt = new TextBox();
            limba_txt = new TextBox();
            add_book_btn = new Button();
            id_carte_lbl = new Label();
            titlu_lbl = new Label();
            autor_lbl = new Label();
            loc_pub_lbl = new Label();
            an_pub_lbl = new Label();
            id_czu_lbl = new Label();
            pret_lbl = new Label();
            ...
            datelecartii_lbl.Text = "Datele cărții:";
            // 
            // titlu_txt
            // 
            ...
            add_book_btn.Text = "Adaugă carte";
            ...
            loc_pub_lbl.Text = "Locul Publicării";
            // 
            // an_pub_lbl
            // 
            ...
            an_pub_lbl.Text = "Anul Publicării";
            // 
            // id_czu_lbl
            // 
            ...
            nr_exemp_lbl.Text = "Număr Exemplare";
            // 
            // limba_lbl
            // 
            ...
            Controls.Add(pret_lbl);
            Controls.Add(id_czu_lbl);
            Controls.Add(an_pub_lbl);
            Controls.Add(loc_pub_lbl);
            Controls.Add(autor_lbl);
            Controls.Add(titlu_lbl);
            Controls.Add(id_carte_lbl);
            Controls.Add(datelecartii_lbl);
            Controls.Add(limba_txt);
            Controls.Add(nr_exemp_txt);
            Controls.Add(pret_txt);
            Controls.Add(id_czu_txt);
            Controls.Add(an_pub_txt);
            Controls.Add(loc_pub_txt);
            Controls.Add(autor_txt);
            Controls.Add(titlu_txt);
        ...
        private Label datelecartii_lbl;
        private TextBox titlu_txt;
        private TextBox autor_txt;
        private TextBox loc_pub_txt;
        private TextBox an_pub_txt;
        private TextBox id_czu_txt;
        private TextBox pret_txt;
        private TextBox nr_exemp_txt;
        private TextBox limba_txt;
        private Button add_book_btn;
        private Label id_carte_lbl;
        private Label titlu_lbl;
        private Label autor_lbl;
        private Label loc_pub_lbl;
        private Label an_pub_lbl;
        private Label id_czu_lbl;
        private Label pret_lbl;
